...
//        return parent::index();
    ...
    public function configureMenuItems(): iterable
    {
        ...
        yield MenuItem::linkToCrud('Modifier une catégorie', 'fa-solid fa-pen-to-square', DishCategory::class);
        yield MenuItem::section('La carte');
        yield MenuItem::linkToCrud('Ajouter un plat', 'fas fa-plus', Dish::class)->setAction(Crud::PAGE_NEW);
        yield MenuItem::linkToCrud('Modifier un plat', 'fa-solid fa-pen-to-square', Dish::class);
        ...
        yield MenuItem::linkToCrud('Modifier une formule', 'fa-solid fa-pen-to-square', Formula::class);
        yield MenuItem::section('Les menus');
        yield MenuItem::linkToCrud('Ajouter un menu', 'fas fa-plus', Menu::class)->setAction(Crud::PAGE_NEW);
        yield MenuItem::linkToCrud('Modifier un menu', 'fa-solid fa-pen-to-square', Menu::class);
        ...
        yield MenuItem::linkToCrud('Modifier les heures d\'ouverture', 'fa-solid fa-pen-to-square', OpeningHour::class);
        ...
        yield MenuItem::linkToCrud('Modifier la galerie d\'image', 'fa-solid fa-pen-to-square', Picture::class);
