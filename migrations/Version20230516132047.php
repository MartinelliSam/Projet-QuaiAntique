 ...
 */
final class Version20230516132047 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE reservation CHANGE time time INT NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE reservation CHANGE time time INT DEFAULT 0 NOT NULL');
    }
}
